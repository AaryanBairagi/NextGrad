...
#         university = data['University Rating']
#         sop = data['SOP']
#         lor = data['LOR']
#         cgpa = data['CGPA']
#         research = data['Research']

#         features = np.array([[gre, toefl, university, sop, lor, cgpa, research]])
#         prediction = model.predict(features)

#         chance_of_admission = prediction[0] * 100
#         return jsonify({'chance': round(chance_of_admission, 2)})
